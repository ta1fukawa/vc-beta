...
def get_args():
    ...
    parser.add_argument('--code-id',  default='default_ge2e', type=str, metavar='ID',   help='プログラムコードの識別コード')
...
def main(cfg):
    ...
    if not cfg.no_learn:
        ...
        valid_loader = DataLoader(unknown_person_list, check_voice_list, (cfg.person_unknown_size, cfg.batch_length_phoneme), cfg.dataset_path, cfg.deform_type, cfg.phonemes_length, cfg.use_mel, seed=0)
...
def learn(model, loaders, weights_path, leaning_rate, patience):
    ...
    for epoch in range(256):
        ...
        train_loss = train(model, loaders[0], optimizer, criterion)
